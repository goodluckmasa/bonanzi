...
def MergeMaskedFace (predictor_func, predictor_input_shape,
                     ...
                     cfg, frame_info, img_bgr_uint8, img_bgr, img_face_landmarks, alpha_img):
...
def MergeMasked (predictor_func,
    ...
    for face_num, img_landmarks in enumerate( frame_info.landmarks_list ):
        out_img, out_img_merging_mask = MergeMaskedFace (predictor_func, predictor_input_shape, face_enhancer_func, xseg_256_extract_func, cfg, frame_info, img_bgr_uint8, img_bgr, img_landmarks, frame_info.alpha_images_list[face_num])
